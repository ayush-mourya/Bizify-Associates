const serviceSectionsData = {
    ...
    "license-section": [
        { imageSrc: "assets/License/ISO-registration.png", altText: "ISO reg.", title: "ISO reg.", path: "Services/License/iso-reg.html" },
    ...
    "file-gst-section": [
        ...
        { imageSrc: "assets/File-GST/reply-to-gst.png", altText: "Reply to GST Notice", title: "Reply to GST Notice", path: "Services/File GST/reply-to-gst-notice.html" },
        { imageSrc: "assets/File-GST/cancelation-and-revocation.png", altText: "GST Cancellation and Revocation", title: "GST Cancellation and Revocation", path: "Services/File GST/gst-cancellation-and-revocation.html" },
    ]
};
